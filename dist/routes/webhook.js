...
router.post('/sms', async (req, res) => {
    ...
    const business = (0, db_1.getBusinessByPhone)(businessPhone);
    if (!business) {
    ...
    if (cleanMessage.toUpperCase() === 'CANCEL') {
        const appt = (0, db_1.getLatestAppointmentByPhone)(customerPhone, business.id);
        if (appt) {
            (0, db_1.updateAppointmentStatus)(appt.id, 'cancelled');
    ...
    try {
        const conversation = (0, db_1.getOrCreateConversation)(business.id, customerPhone);
        ...
        if (booking) {
            ...
            (0, db_1.updateConversation)(conversation.id, [
                ...messages,
